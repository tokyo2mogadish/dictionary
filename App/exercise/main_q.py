...
def home():#request handler
    ...
    #jp.QBtn(a = div2, text = 'Calculate', click = sum_up, in1 = in1, in2 = in2, d_output = d_output,
    #        classes = 'border border-blue-500 m-2 py-1 px-4 rounded text-blue-600 hover:bg-red-500 hover:text-white')
    jp.QBtn(a = div2,color='primary', label='Calculate', icon = 'map', click = sum_up, in1 = in1, in2 = in2, d_output = d_output)
